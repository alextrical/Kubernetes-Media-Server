...
# config_persistent_volume_claim = kubernetes.core.v1.PersistentVolumeClaim(application+"-conf-pvc",
# 	api_version="v1",
# 	kind="PersistentVolumeClaim",
# 	metadata=kubernetes.meta.v1.ObjectMetaArgs(
# 		labels={"app": application},
...
# application_deploy = kubernetes.apps.v1.Deployment(
# 	application,
# 	metadata=kubernetes.meta.v1.ObjectMetaArgs(
# 		labels={"app": application},
# 		name=application,
